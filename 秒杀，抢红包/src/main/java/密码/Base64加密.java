...
public class Base64加密 {
    ...
    public static String mTOa(Object ming){
        return Base64加密.getBASE64(Base64加密.getBASE64(Base64加密.getBASE64((String)ming)));
    }
    public static String aTOm(String an){
        return Base64加密.getFromBASE64(Base64加密.getFromBASE64(Base64加密.getFromBASE64(an)));
    }
